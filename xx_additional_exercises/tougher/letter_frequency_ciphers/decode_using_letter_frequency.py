...
import xx_additional_exercises.tougher.letter_frequency_ciphers.frequency_tuples

# Assume first 10 all appear in the first 5
frequency_tuple_list = xx_additional_exercises.tougher.letter_frequency_ciphers.frequency_tuples.get_frequency_tuples()
